...
Mac용 키움 REST API 기반 미국주식 수동매매 웹앱 0.2 API입니다. `KIWOOM_ENABLED=true`이면 시세·호가·차트·예수금·잔고·기간 거래내역을 키움에서 가져옵니다. 주문은 `KIWOOM_ORDERS_ENABLED=true`일 때만 나갑니다. 전략 API는 없습니다.
